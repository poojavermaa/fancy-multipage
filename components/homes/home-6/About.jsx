        ...
        <div className="me-xl-4 pe-sm-2">
          <div className="composition-1">
            <div className="composition-1-image-1">
              <Image
                src="/assets/images/demo-fancy/section-image-1.webp"
                width={480}
                height={358}
            ...
            <div className="composition-1-image-2">
              <Image
                src="/assets/images/demo-fancy/section-image-2.webp"
                width={440}
                height={330}
                alt="Image Description"
              />
        ...
        <div className="ms-xl-5 ps-sm-2 me-xl-4 pe-sm-2 pe-xl-3">
          <div className="composition-2">
            <div className="composition-2-image-1 mt-xs-0">
              <Image
                src="/assets/images/demo-fancy/section-image-3.webp"
                width={372}
                height={500}
                alt="Image Description"
              />
            ...
            <div className="composition-2-image-2">
              <Image
                src="/assets/images/demo-fancy/section-image-4.webp"
                alt="Image Description"
                width={440}
                height={330}
              />
        ...
        <div className="ms-xl-4 ps-sm-2">
          <div className="composition-3">
            <div className="composition-3-image-1">
              <Image
                src="/assets/images/demo-fancy/section-image-6.webp"
                width={500}
                height={372}
                alt="Image Description"
              />
            ...
            <div className="composition-3-image-2">
              <Image
                src="/assets/images/demo-fancy/section-image-5.webp"
                width={440}
                height={330}
                alt="Image Description"
              />
